/**
 * Maps the numeric and textual representation of each factor that gets multiplied with a multiplier
 */
var keywords= {
               "factors": {
                          "one":1,
...
/**
 * @function
 * @param {string} num-The number that will be converted to its textual format
 * @returns {string}
 */
export default (num)=>{
    var text="",indexing=[];
